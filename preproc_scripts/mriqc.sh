...
mriqc /gpfs/group/mnh5174/default/NeuroMAP/bids/ /gpfs/group/mnh5174/default/NeuroMAP/mriqc_IQMs/ participant --participant-label $sub -w /gpfs/group/mnh5174/default/NeuroMAP/mriqc_tempfiles
