...
rel "python ${pipedir}/mri_fidelity_checks/${code_dir}/feeder.py ${pipedir}/mri_fidelity_checks/$fidelity_json $loc_bids_root ${loc_root}/fidelity_checks $sub" $rel_suffix
